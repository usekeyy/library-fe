...
class ModalForm extends Component {
  ...
  showByUUID = (id) => {
    if(this._isMounted){
      ...
      this.props.showSpecificPlanner(id)
      .then((resp) => {
        let data = resp.data.data;
        let sendDt = {...this.state.sendDt}
        sendDt.general_planner_id = { value: data.general_planner_id, label: `${data.general_planner_name}` };
  ...
  render(){
    ...
    return (
      <div>
            ...
            {this.props.uuid!==""?  "Edit" : "Form"} Specific Planner
          </ModalHeader>
          {this.state.loading && (
            <center>
              <br/>
