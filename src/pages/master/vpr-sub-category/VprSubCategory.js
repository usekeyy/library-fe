...
import { fetchVprSubCategory, showVprSubCategory, deleteVprSubCategory, saveVprSubCategory, updateVprSubCategory, fetchVprCategory } from '../../../store/actions/master/vprActions';
...
class VprSubCategory extends Component {
    constructor(props) {
        super(props)
        ...
        this.columns = [
            ...
            },
            {
                ...
                Filter: ({ filter, onChange }) => (
                    <input className="form-control" name="category_name" onChange={(event) => this.onChanged(event)} value={this.state.params.category_name} />
                )
            },
            {
				Header: "Sub Category VPR",
    ...
    asyncData = async () => {
        ...
        this.props.fetchVprSubCategory(this.state.params)
            .then((resp) => {
                this.setState({
                    data: resp.data.data,
    ...
    savePayload = (type, payload) => {
        if (type === "save") {
            ...
            this.props.saveVprSubCategory(payload)
                .then((resp) => {
    ...
    updatePayload = (type, id, payload) => {
        if (type === "update") {
            this.setState({ loadingSubmit: true });
            this.props.updateVprSubCategory(id, payload)
                .then((resp) => {
                    toastr.success(resp.data.message);
                    this.setState({ modalOpen: false, loadingSubmit: false }, () => this.req())
                    console.log(resp)
    ...
    deletePayload = (type) => {
        this.props.deleteVprSubCategory(type)
            .then((resp) => {
        ...
        return (
            <div>
                <ol className="breadcrumb float-xl-right">
                    ...
                    <li className="breadcrumb-item active">VPR Sub Category</li>
                </ol>
                <h1 className="page-header">VPR SubCategory  <small>Master Data VPR Sub Category</small></h1>
                <Panel loading={false}>
                    <PanelHeader>
                        VPR Sub Category
                    </PanelHeader>
                ...
                {this.state.modalOpen &&
                    <ModalForm
                        ...
                        showVprSubCategory={this.props.showVprSubCategory}
                        fetchVprCategory = {this.props.fetchVprCategory}
...
const dispatchToProps = dispatch => {
    return {
        ...
        showVprSubCategory: (id) => dispatch(showVprSubCategory(id)),
        deleteVprSubCategory: (id) => dispatch(deleteVprSubCategory(id)),
        saveVprSubCategory: (id, payload) => dispatch(saveVprSubCategory(id, payload)),
        updateVprSubCategory: (id, payload) => dispatch(updateVprSubCategory(id, payload)),
    }
}

export default connect(stateToProps, dispatchToProps)(withTranslation()(VprSubCategory));
