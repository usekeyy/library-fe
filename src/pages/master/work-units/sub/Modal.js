...
class ModalForm extends Component {
  ...
  getUUID() {
    ...
    this.props.showWorkUnits(this.props.uuid)
      .then((resp) => {
    ...
    return (
      <div>
        <Modal isOpen={this.props.toggleAdd} toggle={() => this.toggleClose()}>
          <ModalHeader toggle={() => this.toggleClose()}>{this.props.uuid !== "" ? t("workUnit:modal.title-update") : t("workUnit:modal.title-create")}</ModalHeader>
          {this.state.loading && (
            <center>
              <br />
