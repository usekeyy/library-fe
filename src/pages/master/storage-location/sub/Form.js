			...
			<form onSubmit={handleSubmit(onSubmit)}>
					<ModalBody>
						<div className="form-group">
							<label>{t("storageLocation:label.id")} <span className="text-danger">*</span></label>
						...
						<div className="form-group">
							<label>{t("storageLocation:label.code")} <span className="text-danger">*</span></label>
						...
						<div className="form-group">
							<label>{t("storageLocation:label.name")} <span className="text-danger">*</span></label>
						...
						<div className="form-group">
							<label>{t("storageLocation:label.plant-id")} <span className="text-danger">*</span></label>
							<Controller
					...
					<ModalFooter>
								<button className="btn btn-white" disabled={loading} onClick={() => props.toggleClose()}>{t("storageLocation:button.close")}</button>
								<button className="btn btn-success" type="submit" disabled={loading}>
									{loading && <i className="fas fa-spinner fa-pulse"></i> }
									{props.uuid !== "" ? t("storageLocation:button.update") : t("storageLocation:button.submit")}
								</button>
					</ModalFooter>
			</form>
		</div>
