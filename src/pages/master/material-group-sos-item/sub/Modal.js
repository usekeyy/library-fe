...
class ModalForm extends Component {
  ...
  getUUID() {
    if (this._isMounted) {
      ...
      this.props.showMaterialGroupSosItem(this.props.uuid)
        .then((resp) => {
          let data = resp.data.data;
          ...
          sendData.sub_bidang_usaha_id = {
            value: data.sub_bidang_usaha_id,
            label: data.sub_bidang_usaha_id + ' - ' + data.sub_bidang_usaha_name,
          }
          sendData.status = {
            value: data.status,
  ...
  setOption(payload){
    ...
    sendData.sub_bidang_usaha_id = payload.sub_bidang_usaha_id.value;
    if(payload.status){
      ...
      <div>
        <Modal isOpen={this.props.toggleAdd} toggle={() => this.toggleClose()}>
          <ModalHeader toggle={() => this.toggleClose()}>
            {this.props.uuid !== "" ? t("materialGroupSosItem:modal.title-update") : t("materialGroupSosItem:modal.title-create")}
          </ModalHeader>
          {this.state.loading && (
            <center>
              <br />
