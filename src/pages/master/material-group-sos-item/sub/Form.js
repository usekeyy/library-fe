		...
		<div>
			<form onSubmit={handleSubmit(onSubmit)}>
				<ModalBody>
					...
					<div className="form-group">
						<label>{t("materialGroupSosItem:label.material_group")} <span className="text-danger">*</span></label>
						<div>
							<Controller
					...
					<div className="form-group">
						<label>{t("materialGroupSosItem:label.sub_bidang_usaha")} <span className="text-danger">*</span></label>
						<div>
							<Controller
								components={animatedComponents}
								closeMenuOnSelect={true}
								...
								placeholder={loadings.sub_bidang_usaha ? t("common:Select.Sedang Memuat"): t("common:Select.Pilih") }
								isLoading={loadings.sub_bidang_usaha}
								rules={{ required: false }}
							/>
							{errors.sub_bidang_usaha && <span className="text-danger">* This field is required</span>}
							{props.errors.sub_bidang_usaha && <span className="text-danger">{props.errors.sub_bidang_usaha[0]}</span>}
						</div>
					</div>
					{props.uuid !== "" && 
						<div className="form-group">
				...
				<ModalFooter>
					<button className="btn btn-white" onClick={() => props.toggleClose()}>{t("materialGroupSosItem:button.close")}</button>
