			...
			<form onSubmit={handleSubmit(onSubmit)}>
				<ModalBody>
					<div className="form-group">
						<label>{t("maintPlannerGroup:label.id")} <span className="text-danger">*</span></label>
					...
					<div className="form-group">
						<label>{t("maintPlannerGroup:label.code")} <span className="text-danger">*</span></label>
					...
					<div className="form-group">
						<label>{t("maintPlannerGroup:label.name")} <span className="text-danger">*</span></label>
					...
					<div className="form-group">
						<label>{t("maintPlannerGroup:label.plant-id")} <span className="text-danger">*</span></label>
						<Controller
				...
				<ModalFooter>
					<button className="btn btn-white" disabled={loading} onClick={() => props.toggleClose()}>{t("maintPlannerGroup:button.close")}</button>
					<button className="btn btn-success" type="submit" disabled={loading}>
						{loading && <i className="fas fa-spinner fa-pulse"></i>}
						{props.uuid !== "" ? t("maintPlannerGroup:button.update") : t("maintPlannerGroup:button.submit") }
					</button>
				</ModalFooter>
			</form>
		</div>
