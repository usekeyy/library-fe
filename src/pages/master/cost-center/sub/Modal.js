...
class ModalForm extends Component {
  ...
  getUUID() {
    if (this._isMounted) {
      ...
      this.props
        .showCostCenter(this.props.uuid)
        .then((resp) => {
          ...
          sendData.company_area = data.company_area;
          sendData.description = data.description;
          sendData.valid_from = data.valid_from;
          sendData.valid_to = data.valid_to;
  ...
  setOption(payload){
    ...
    sendData.company_area = payload.company_area;
    sendData.description = payload.description;
    sendData.valid_from = payload.valid_from;
    sendData.valid_to = payload.valid_to;
      ...
      <div>
        <Modal isOpen={this.props.toggleAdd} toggle={() => this.toggleClose()}>
          <ModalHeader toggle={() => this.toggleClose()}>
            {this.props.uuid !== "" ? t("costCenter:modal.title-update") : t("costCenter:modal.title-create")}
          </ModalHeader>
          {this.state.loading && (
            <center>
              <br />
