...
class ModalForm extends Component {
  ...
  getUUID() {
    ...
    this.props.showIncoterms(this.props.uuid)
      .then((resp) => {
    ...
    return (
      <div>
        <Modal isOpen={this.props.toggleAdd} toggle={() => this.toggleClose()}>
          <ModalHeader toggle={() => this.toggleClose()}> {this.props.uuid !== "" ? t("incoterms:modal.title-update") : t("incoterms:modal.title-create")}</ModalHeader>
          {this.state.loading && (
            <center>
              <br />
