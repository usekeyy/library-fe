		...
		<div>
			<form onSubmit={handleSubmit(onSubmit)}>
				<ModalBody>
					...
					<div className="form-group">
						<label >{t("documentType:label.company_id")} <span className="text-danger">*</span> </label>
					...
					<div className="form-group">
						<label>{t("documentType:label.document_category")}<span className="text-danger">*</span></label>
						<div>
							<Controller
								components={animatedComponents}
								closeMenuOnSelect={true}
