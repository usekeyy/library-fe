      ...
      this.props
        ...
        .then((resp) => {
          ...
          sendData.sub_district_id = {
            ...
            label: data.sub_district_id + ' - ' + data.sub_district_name,
          };
          this.getCountries();
          this.getRegions(data.country_id);
          this.getDistrict(data.region_id);
          this.getSubDistrict(data.district_id);
  ...
  getSubDistrict(payload) {
    if (this._isMounted) {
      this.setState(({ loadings, isDisabled }) => ({
        ...
        isDisabled: { ...isDisabled, subDistrict: true },
      }));
      var params = {
        district_id: payload,
      };
      this.props
        ...
        .then((resp) => {
          ...
          this.setState(({ loadings, isDisabled }) => ({
            ...
            isDisabled: { ...isDisabled, subDistrict: false },
    ...
    return (
      <div>
        <Modal isOpen={this.props.toggleAdd} toggle={() => this.toggleClose()}>
          ...
          {this.props.uuid !== "" ? t("villages:modal.title-update") : t("villages:modal.title-create") }
          </ModalHeader>
          {this.state.loading && (
            <center>
              <br />
          ...
          {this.state.loading === false && (
            <RouteForm
              ...
              getSubDistrict={(payload) => this.getSubDistrict(payload)}
            />
          )}
        </Modal>
      </div>
