...
class ModalForm extends Component {
  ...
  getUUID() {
    ...
    this.props.showAccountAssignmentCategory(this.props.uuid)
      .then((resp) => {
    ...
    return (
      <div>
        <Modal isOpen={this.props.toggleAdd} toggle={() => this.toggleClose()}>
          <ModalHeader toggle={() => this.toggleClose()}>{this.props.uuid !== "" ? 'Update Account Assg Category' : 'Create Account Assg Category'}</ModalHeader>
          {this.state.loading && (
            <center>
              <br />
