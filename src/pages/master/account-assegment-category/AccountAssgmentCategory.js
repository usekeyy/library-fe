...
import { fetchAccAssignmentCategory, saveAccAssignmentCategory, updateAccAssignmentCategory, showAccAssignmentCategory, deleteAccAssignmentCategory } from '../../../store/actions/master/accAssignmentCategoryActions';
...
class AccountAssgmentCategory extends Component {
    constructor(props) {
        super(props)
    ...
    asyncData = async () => {
        ...
        this.props.fetchAccAssignmentCategory(this.state.params)
            .then((resp) => {
                this.setState({
                    data: resp.data.data,
    ...
    savePayload = (payload) => {
        if (this._isMounted) {
            ...
            this.props.saveAccAssignmentCategory(payload)
                .then((resp) => {
    ...
    updatePayload = (id, payload) => {
        if (this._isMounted) {
            this.setState({ loadingSubmit: true });
            this.props.updateAccAssignmentCategory(id, payload)
                .then((resp) => {
                    toastr.success(resp.data.message);
                    this.setState({ modalOpen: false, loadingSubmit: false, errors: [] }, () => this.req())
                })
    ...
    deletePayload = (type) => {
        this.props.deleteAccAssignmentCategory(type)
            .then((resp) => {
        ...
        return (
            <div>
                <ol className="breadcrumb float-xl-right">
                    ...
                    <li className="breadcrumb-item active">Account Assegment Category</li>
                </ol>
                <h1 className="page-header">Account Assegment Category <small>Master data Account Assegment Category</small></h1>
                <Panel loading={false}>
                    <PanelHeader>
                        Account Assegment Category
					</PanelHeader>
                ...
                {this.state.modalOpen &&
                    <ModalForm
                        ...
                        showAccountAssignmentCategory={this.props.showAccAssignmentCategory}
...
const dispatchToProps = dispatch => {
    return {
        ...
        showAccAssignmentCategory: (id) => dispatch(showAccAssignmentCategory(id)),
        deleteAccAssignmentCategory: (id) => dispatch(deleteAccAssignmentCategory(id)),
        saveAccAssignmentCategory: (payload) => dispatch(saveAccAssignmentCategory(payload)),
        updateAccAssignmentCategory: (id, payload) => dispatch(updateAccAssignmentCategory(id, payload)),
    }
}

export default connect(stateToProps, dispatchToProps)(withTranslation()(AccountAssgmentCategory))