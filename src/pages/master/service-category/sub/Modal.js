...
class ModalForm extends Component {
  ...
  getUUID() {
    ...
    this.props.showServiceCategory(this.props.uuid)
      .then((resp) => {
    ...
    return (
      <div>
        <Modal isOpen={this.props.toggleAdd} toggle={() => this.toggleClose()}>
          <ModalHeader toggle={() => this.toggleClose()}>{this.props.uuid !== "" ? 'Update Service Category' : 'Create Service Category'}</ModalHeader>
          {this.state.loading && (
            <center>
              <br />
