...
import { fetchServiceCategory, updateServiceCategory, showServiceCategory, deleteServiceCategory, saveServiceCategory} from '../../../store/actions/master/serviceCategoryActions';
...
class ServiceCategory extends Component {
    ...
    asyncData = async () => {
        ...
        this.props.fetchServiceCategory(this.state.params)
            .then((resp) => {
                this.setState({
                    data: resp.data.data,
    ...
    savePayload = (payload) => {
        if(this._isMounted){
            ...
            this.props.saveServiceCategory(payload)
            .then((resp) => {
    ...
    updatePayload = (id, payload) => {
        if (this._isMounted) {
            this.setState({ loadingSubmit: true });
            this.props.updateServiceCategory(id, payload)
            .then((resp) => {
                toastr.success(resp.data.message);
                this.setState({ modalOpen: false, loadingSubmit:false , errors:[]}, () => this.req())
            })
    ...
    deletePayload = (type) => {
         this.props.deleteServiceCategory(type)
        .then((resp) => {
        ...
        return (
            <div>
                <ol className="breadcrumb float-xl-right">
                    ...
                    <li className="breadcrumb-item active">Material Service Category</li>
                </ol>
                <h1 className="page-header">Service Category <small>Master data Service Category</small></h1>
                <Panel loading={false}>
                    <PanelHeader>
                    Service Category
					</PanelHeader>
                ...
                {this.state.modalOpen &&
                    <ModalForm
                        ...
                        showServiceCategory={this.props.showServiceCategory}
...
const dispatchToProps = dispatch => {
    return {
        ...
        showServiceCategory: (id) => dispatch(showServiceCategory(id)),
        deleteServiceCategory: (id) => dispatch(deleteServiceCategory(id)),
        saveServiceCategory: (payload) => dispatch(saveServiceCategory(payload)),
        updateServiceCategory: (id, payload) => dispatch(updateServiceCategory(id, payload)),
    }
}

export default connect(stateToProps, dispatchToProps) (withTranslation() (ServiceCategory))