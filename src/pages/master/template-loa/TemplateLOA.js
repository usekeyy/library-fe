...
import { fetchEDocument, showEDocument, deleteEDocument, saveEDocument, updateEDocument } from '../../../store/actions/master/masterLoaActions';
...
class TemplateLOA extends Component {
    constructor(props) {
        super(props)
...
export default connect(stateToProps, dispatchToProps)(withTranslation()(TemplateLOA));
