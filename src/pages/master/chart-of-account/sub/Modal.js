...
class ModalForm extends Component {
  ...
  getUUID() {
    ...
    this.props.showChartOfAccount(this.props.uuid)
      .then((resp) => {
    ...
    return (
      <div>
        <Modal isOpen={this.props.toggleAdd} toggle={() => this.toggleClose()}>
          <ModalHeader toggle={() => this.toggleClose()}>{this.props.uuid !== "" ? 'Update Chart Of Account' : 'Create Chart Of Account'}</ModalHeader>
          {this.state.loading && (
            <center>
              <br />
