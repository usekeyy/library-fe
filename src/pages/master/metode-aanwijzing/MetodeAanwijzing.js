...
import { fetchMetodeAanwijzing, saveMetodeAanwijzing, updateMetodeAanwijzing, showMetodeAanwijzing, deleteMetodeAanwijzing } from '../../../store/actions/master/metodeAanwijzingActions';
...
class MetodeAanwijizing extends Component {
    constructor(props) {
        super(props)
    ...
    asyncData = async () => {
        ...
        this.props.fetchMetodeAanwijzing(this.state.params)
            .then((resp) => {
                this.setState({
                    data: resp.data.data,
    ...
    savePayload = (payload) => {
        if(this._isMounted){
            ...
            this.props.saveMetodeAanwijzing(payload)
            .then((resp) => {
    ...
    updatePayload = (id, payload) => {
        if (this._isMounted) {
            this.setState({ loadingSubmit: true });
            this.props.updateMetodeAanwijzing(id, payload)
            .then((resp) => {
                toastr.success(resp.data.message);
                this.setState({ modalOpen: false,errors:[], loadingSubmit:false }, () => this.req())
            })
    ...
    deletePayload = (type) => {
         this.props.deleteMetodeAanwijzing(type)
        .then((resp) => {
            toastr.success(resp.data.message);
            this.req()
        })
        ...
        return (
            <div>
                <ol className="breadcrumb float-xl-right">
                    ...
                    <li className="breadcrumb-item active">Metode Aanwijzing</li>
                </ol>
                <h1 className="page-header">Metode Aanwijzing<small> Master data Metode Aanwijzing</small></h1>
                <Panel loading={false}>
                    <PanelHeader>
                    Metode Aanwijzing
					</PanelHeader>
                ...
                {this.state.modalOpen &&
                    <ModalForm
                        ...
                        showMetodeAanwijzing={this.props.showMetodeAanwijzing}
...
const dispatchToProps = dispatch => {
    return {
        ...
        showMetodeAanwijzing: (id) => dispatch(showMetodeAanwijzing(id)),
        deleteMetodeAanwijzing: (id) => dispatch(deleteMetodeAanwijzing(id)),
        saveMetodeAanwijzing: (id, payload) => dispatch(saveMetodeAanwijzing(id, payload)),
        updateMetodeAanwijzing: (id, payload) => dispatch(updateMetodeAanwijzing(id, payload)),
    }
}

export default connect(stateToProps, dispatchToProps)(withTranslation()(MetodeAanwijizing));