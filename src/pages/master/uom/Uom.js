...
import {fetchUom, saveUom, showUom, updateUom, deleteUom} from '../../../store/actions/master/uomActions';
  ...
  render(){
    ...
    return (
      <div>
				...
				<h1 className="page-header">Uom </h1>
				<Panel loading={false}>
					<PanelHeader>{t("uom:table-title")}</PanelHeader>
...
const dispatchToProps = dispatch => {
	return {
		...
		updateUom: (id, payload) => dispatch(updateUom(id, payload)),
		deleteUom: (id) => dispatch(deleteUom(id)),
	}
}

export default connect(stateToProps, dispatchToProps)( withTranslation() (Uom));