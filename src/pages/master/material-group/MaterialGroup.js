...
import { fetchMaterialGroup , saveMaterialGroup , updateMaterialGroup , showMaterialGroup, deleteMaterialGroup} from '../../../store/actions/master/materialGroupActions';
...
class MaterialGroup extends Component {
    ...
    asyncData = async () => {
        ...
        this.props.fetchMaterialGroup(this.state.params)
            .then((resp) => {
                this.setState({
                    data: resp.data.data,
    ...
    savePayload = (payload) => {
        if(this._isMounted){
            ...
            this.props.saveMaterialGroup(payload)
            .then((resp) => {
    ...
    updatePayload = (id, payload) => {
        if (this._isMounted) {
            this.setState({ loadingSubmit: true });
            this.props.updateMaterialGroup(id, payload)
            .then((resp) => {
                toastr.success(resp.data.message);
                this.setState({ modalOpen: false, loadingSubmit:false , errors:[]}, () => this.req())
            })
    ...
    deletePayload = (type) => {
         this.props.deleteMaterialGroup(type)
        .then((resp) => {
            toastr.success(resp.data.message);
            this.req()
        })
        ...
        return (
            <div>
                <ol className="breadcrumb float-xl-right">
                    ...
                    <li className="breadcrumb-item active">Material Group</li>
                </ol>
                <h1 className="page-header">Material Group <small>Master data Material Group</small></h1>
                <Panel loading={false}>
                    <PanelHeader>
                    Material Group
					</PanelHeader>
                ...
                {this.state.modalOpen &&
                    <ModalForm
                        ...
                        showMaterialGroup={this.props.showMaterialGroup}
...
const dispatchToProps = dispatch => {
    return {
        ...
        showMaterialGroup: (id) => dispatch(showMaterialGroup(id)),
        deleteMaterialGroup: (id) => dispatch(deleteMaterialGroup(id)),
        saveMaterialGroup: (id, payload) => dispatch(saveMaterialGroup(id, payload)),
        updateMaterialGroup: (id, payload) => dispatch(updateMaterialGroup(id, payload)),
    }
}

export default connect(stateToProps, dispatchToProps) (withTranslation() (MaterialGroup))