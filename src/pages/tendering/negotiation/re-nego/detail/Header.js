						...
						<Row>
							<Col sm="12">
								...
								<div className="form-group row">
										...
										<div className="col-sm-10">
												<input type="text" readOnly={true} name="status" ref={register({})} className={(errors['status']) ? "form-control is-invalid" : "form-control"} placeholder="" defaultValue={(header.uuid !== "") ? 'Re Nego' : ''} />
