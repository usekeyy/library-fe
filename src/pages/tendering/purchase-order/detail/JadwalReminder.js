        ...
        rows = Object.keys(props.data_reminder).map(function (key, index) {
            return (
                <tr key={key}>
                    ...
                    <td>{props.data_reminder[key]['purchasing_requisition_number']} - {props.data_reminder[key]['item_no']} - {props.data_reminder[key]['item_desc']}</td>
                    ...
                    <td>
                        <button className="btn btn-xs btn-success" onClick={(e) => modalTemplate(e, props.data_reminder[key]['uuid'], 'template-reminder-detail')} ><i className="fa fa-list"></i></button>
                        {/* {props.data.created_by === props.user.uuid &&
                            <button className="btn btn-xs btn-danger" onClick={(e) => props.toggleDelete(e, props.data_reminder[key]['uuid'], 'jadwal-reminder')} ><i className="fa fa-trash"></i></button>
                        } */}
                    </td>
                </tr>
            )
                                            ...
                                            <div className="col-sm-6">
                                                <div className="form-group row">
                                                    ...
                                                    <div className="col-sm-4">
                                                        <button className="btn btn-white" onClick={(e) => modalTemplate(e, '', 'template-reminder-create')} >New Template</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
