				...
				<div className="form-row">
					...
					<div className="form-group col-md-6">
						...
						<Controller
							...
							defaultValue={((props.data.items.material_id !== undefined && props.data.items.material_id!=="") ? {label:props.data.items.material_id +" - "+ props.data.items.material_name, value:props.data.items.material_name } : null)}
							isDisabled={props.disabledForm}
						/>
					</div>
