...
import Header from '../../registrasi-undangan-tender/sub/Header';
import Item from '../../registrasi-undangan-tender/sub/Item';
import Detail from '../../registrasi-undangan-tender/sub/Detail';
import Scope from '../../registrasi-undangan-tender/sub/Scope';
import Note from '../../registrasi-undangan-tender/sub/Note';
import Schedule from '../../registrasi-undangan-tender/sub/Schedule';
import Term from '../../registrasi-undangan-tender/sub/Term';
// import Process from '../../registrasi-undangan-tender/sub/Process';
	...
	return (
		<FormContext {...methods} >
			<form onSubmit={methods.handleSubmit(onSubmit)}>
				...
				{/* {<Process parentProps={props.parentProps} parentState={props.parentState} upload={props.upload} />} */}
