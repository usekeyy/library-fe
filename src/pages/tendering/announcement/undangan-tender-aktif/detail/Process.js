											...
											<div className="col-md-12">
												<div className="form-group row m-b-10">
													...
													<div className="col-md-9">
														<div className="radio radio-css">
															<input type="radio" ref={register({})} checked={checkProses === 'register'} onChange={(e) => setCheckProses('register')}  name="status" id="register" value="register" />
															<label htmlFor="register">Register</label>
														</div>
														<div className="radio radio-css">
															<input type="radio" ref={register({})} checked={checkProses === 'reject'} onChange={(e) => setCheckProses('reject')} name="status" id="reject" value="reject" />
												...
												{(checkProses === 'reject') && <div className="form-group row m-b-10">
													...
													<div className="col-sm-6">
															<input type="text" className={validFileLampiran === true ? "form-control is-invalid" : "form-control"} name="file" ref={register({ required: false })} placeholder="" disabled={true} defaultValue={filelampiran} />
															{validFileLampiran === true && <span className="text-danger"> {"File is required"} </span>}
													</div>
