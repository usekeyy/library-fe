    ...
    return (
        <div>
            <Panel className="margin-bot-false">
                <PanelHeader>{t("bidOpening:panel-title.detail-tender")}</PanelHeader>
                <PanelBody >
                    <div className="row">
                        <div className="col-sm-12">
                            <div className="row">
                                <label className="col-sm-3 col-form-label">{t("bidOpening:label.procurment-method")}</label>
                            ...
                            <div className="row">
                                <label className="col-sm-3 col-form-label">{t("bidOpening:label.aanwijzing-method")}</label>
                                <div className="col-sm-9">
                                    <label className=" col-form-label">: {props.metode_aanwijzing_name !== undefined ? props.metode_aanwijzing_name : ''}</label>
                                </div>
                            </div>
                            <div className="row">
                                <label className="col-sm-3 col-form-label">{t("bidOpening:label.delivery-method")}</label>
                                <div className="col-sm-9">
                                    <label className=" col-form-label">: {props.metode_penyampaian_name !== undefined ? props.metode_penyampaian_name : ''}</label>
                                </div>
                            </div>
                            <div className="row">
                                <label className="col-sm-3 col-form-label">{t("bidOpening:label.evaluation-method")}</label>
                                <div className="col-sm-9">
                                    <label className=" col-form-label">: {props.metode_evaluasi !== undefined ? props.metode_evaluasi : ''}</label>
                                </div>
                            </div>
                            <div className="row">
                                <label className="col-sm-3 col-form-label">{t("bidOpening:label.negoitation-method")}</label>
                                <div className="col-sm-9">
                                    <label className=" col-form-label">: {props.metode_negosiasi !== undefined ? props.metode_negosiasi : ''}</label>
                                </div>
                            </div>
                            <div className="row">
                                <label className="col-sm-3 col-form-label">{t("bidOpening:label.order-placement")}</label>
                                <div className="col-sm-9">
