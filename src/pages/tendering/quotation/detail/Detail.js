                                ...
                                <div className="col-sm-9">
                                    <label className=" col-form-label">: {
                                            header.pra_qualification !== undefined
                                                ? (header.pra_qualification === "n" || parseInt(header.pra_qualification) === 0)
                                                    ? "Not Active"
                                                    : "Active"
                                                : ''
                                        }</label>
                                ...
                                <div className="col-sm-9">
                                    <label className=" col-form-label">: {
                                            header.metode_evaluasi !== undefined
																						? header.metode_evaluasi.toString().indexOf('_') !== -1 ? toTitleCase(header.metode_evaluasi.split('_').join(' ')) : header.metode_evaluasi
																						: ''
                                        }</label>
                                </div>
                            </div>
                            <div className="row">
                                ...
                                <div className="col-sm-9">
                                    <label className=" col-form-label">: {
																						...
																						? header.metode_negosiasi.toString().indexOf('_') !== -1 ? toTitleCase(header.metode_negosiasi.split('_').join(' ')) : header.metode_negosiasi
																						: ''
                                        }</label>
                                </div>
                            </div>
