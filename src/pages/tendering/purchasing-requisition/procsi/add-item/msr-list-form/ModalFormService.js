...
import MsrFormItem from './ServiceFormItem'
...
class ModalFormService extends Component {
  constructor(props) {
    super(props)
    ...
    return (
      <div>
        ...
        <ModalHeader toggle={() => this.toggleClose()}>Modal {}</ModalHeader>
          <MsrFormItem
            is_edit_service_line={this.props.is_edit_service_line}
            ...
            updateServiceItem={(uuid, payload) => this.props.updateServiceItem(uuid, payload)}
...
export default connect(stateToProps, dispatchToProps)((ModalFormService));
