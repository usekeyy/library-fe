  ...
  return (
    <div>
      <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="col-sm-10">
                      <Controller
                        ...
                        onInputChange={(props, { action }) =>
                          onInputChange("gl_account", props, action)
                        }
                  ...
                  <div className="form-group row">
                    ...
                    <div className="col-sm-10">
                      ...
                      <Controller
                        ...
                        name="cost_center_id"
                        onInputChange={(props, { action }) =>
                          onInputChange("cost_center", props, action)
                        }
                  ...
                  <div className="form-group row">
                    ...
                    <div className="col-sm-10">
                      ...
                      <Controller
                        ...
                        name="asset_id"
                        onInputChange={(props, { action }) =>
                          onInputChange("asset", props, action)
                        }
                  ...
                  <div className="form-group row">
                    ...
                    <div className="col-sm-10">
                      ...
                      <Controller
                        ...
                        onInputChange={(props, { action }) =>
                          onInputChange("profit_center", props, action)
                        }
                  ...
                  <div className="form-group row">
                    ...
                    <div className="col-sm-10">
                      ...
                      <Controller
                        ...
                        name="wbs_id"
                        onInputChange={(props, { action }) =>
                          onInputChange("wbs", props, action)
                        }
                        options={master.wbs}
                        defaultValue={""}
                        isDisabled={props.disabledForm}
        ...
        <ModalFooter>
          <button className="btn btn-white" onClick={() => props.toggleClose()}>
            {t("costCenter:button.close")}
          </button>
          <button className="btn btn-success" type="submit">
            {t("costCenter:button.submit")}
          </button>
        </ModalFooter>
      </form>
    </div>
...
export default withTranslation()(AccountAssignment);
