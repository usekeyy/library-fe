...
class PraQualificationKlarifikasi extends Component {
    constructor(props) {
        super(props)
        ...
        this.columns = [
            ...
            // },
            {
                ...
                Cell: ({ value }) => (
                    ...
                    <label>{value.start_date} {value.start_time.toString().substr(0, 5)}</label>
                )
            },
            {
                Header: "End Date",
                ...
                Cell: ({ value }) => (
                    ...
                    <label>{value.end_date} {value.end_time.toString().substr(0, 5)}</label>
                )
            },
            {
                Header: "Status",
    ...
    asyncData = async () => {
        ...
        this.props.countPraQualificationKlarifikasi(this.state.params)
            .then((resp) => {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <h1 className="page-header">Proposal Tender - Pra Qualification Klarifikasi<small></small></h1>
...
export default connect(stateToProps, dispatchToProps)(withTranslation()(PraQualificationKlarifikasi));
