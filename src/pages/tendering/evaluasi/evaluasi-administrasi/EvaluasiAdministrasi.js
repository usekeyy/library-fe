...
import { fetchEvaluation  } from '../../../../store/actions/tendering/evaluationAdministrationActions'
import { Modal, ModalHeader } from 'reactstrap';
import FilterDate from '../../../../components/filterdate/FilterDate';
const ReactTableFixedColumns = withFixedColumns(ReactTable);

class EvaluasiAdministrasi extends Component {
    constructor(props) {
        super(props)
        ...
        this.columns = [
            ...
            {
                Header: ()=> this.props.t("evaluation:label.date-bid"),
                id: "clossing_date",
    ...
    asyncData = async () => {
        ...
        this.props.fetchEvaluation(this.state.params)
            .then((resp) => {
                this.setState({
                    data: resp.data.data,
    ...
    edits(e, value) {
        this.props.history.push('/tendering/evaluation-administration/detail/' + value)
    }
    ...
    render() {
        ...
        return (
            ...
            <Panel loading={false} className="margin-bot-false">
                <PanelHeader>
                   {t("evaluation:title-administrative-evaluation")}
                </PanelHeader>
...
const dispatchToProps = dispatch => {
    return {
        fetchEvaluation: (params) => dispatch(fetchEvaluation(params)),
        // registrationAanwijzing: (id,payload) => dispatch(registrationAanwijzing(id,payload)),
    }
}

export default connect(stateToProps, dispatchToProps)(withTranslation()(EvaluasiAdministrasi))
