                ...
                <PanelBody>
                    <Row>
                        <Col sm="12">
                            ...
                            <div className="row">
                                <label className="col-sm-3 col-form-label">Due Date Klarifikasi</label>
                                <div className="col-sm-9">
                                    <input type="text" readOnly className="form-control-plaintext" defaultValue={(props.due_date===null || props.due_date===undefined )? ":" : ": "+ formatDate(props.due_date, false)} />
                                </div>
                            </div>
...
export default withTranslation()(HeaderKlarifikasi);