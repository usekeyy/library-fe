        ...
        rows = Object.keys(props.data).map(function (key, index) {
            ...
            props.data[key]['vendor'].forEach((element, i) => {
                ...
                <tr key={i}>
                    ...
                    <td>
                     {props.evaluasiBtn && <button className="btn btn-xs btn-warning m-r-5" value={props.data[key]['vendor'][i]['vendor_id']} onClick={(e) => props.evaluasiVendor(e, props.data[key]['vendor'][i]['vendor_id'],props.data[key]['pr_item_uuid'])}  >Evaluasi</button> }
                    </td>
                </tr>
                )
            })
