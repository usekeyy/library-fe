...
import { fetchEvaluationKomersial } from '../../../../store/actions/tendering/evaluationCommercialActions'
...
class EvaluasiTeknis extends Component {
    constructor(props) {
        ...
        this.columns = [
            ...
            },
            {
                ...
                id: "assigned_date",
                accessor: d => d.assigned_date,
                Filter: ({ filter, onChange }) => (
                    <FilterDate type="assigned_date" getDate={this.assigned_date} />
                )
            },
            {
                Header: "Assigned To",
    ...
    asyncData = async () => {
        ...
        this.props.fetchEvaluationKomersial(this.state.params)
            .then((resp) => {
                this.setState({
                    data: resp.data.data,
    ...
    edits(e, value) {
        this.props.history.push('/tendering/evaluation-commercial/detail/' + value)
    }
        ...
        return (
            <div>
                ...
                <Panel loading={false} className="margin-bot-false">
                    <PanelHeader>
                    {t("evaluation:title-commecial-evaluation")}
                </PanelHeader>
...
const dispatchToProps = dispatch => {
    return {
        fetchEvaluationKomersial: (params) => dispatch(fetchEvaluationKomersial(params)),
    }
}
