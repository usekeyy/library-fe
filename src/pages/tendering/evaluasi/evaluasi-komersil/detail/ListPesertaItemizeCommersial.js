        ...
        rows = Object.keys(props.data).map(function (key, index) {
            ...
            props.data[key]['vendor'].forEach((element, i) => {
                ...
                <tr key={i}>
                    ...
                    {props.metode_evaluasi ==="sistem_nilai" && <th>{props.data[key]['vendor'][i]['score_komersil']}</th>}
                    <td>{props.data[key]['vendor'][i]['evaluasi_komersil']}</td>
                    <td>
                     <button className="btn btn-xs btn-warning m-r-5" value={props.data[key]['vendor'][i]['vendor_id']} onClick={(e) => props.evaluasiVendor(e, props.data[key]['vendor'][i]['vendor_id'],props.data[key]['pr_item_id'])}  >Evaluasi</button> 
                    </td>
                </tr>
                )
            })
