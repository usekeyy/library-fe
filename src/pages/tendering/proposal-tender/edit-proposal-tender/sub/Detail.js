...
const Detail = (props) => {
    // const { t } = props;
		...
		const [showPraQualificationn, setShowPraQualification] = React.useState(parseInt(header.metode_pengadaan_id) !== 10)
		...
		const handleChangeMetodePenyampaian = (e) => {
			...
			props.fetchJadwalTender(params)
		}
						...
						<Row>
							<Col sm="12">
								...
								{showPraQualificationn && <div className="form-group row">
										...
										<div className="form-group row col-md-10">
												<div className="checkbox checkbox-css">
													<input type="checkbox" id="pra_qualification" name="pra_qualification" defaultChecked={header.pra_qualification === 1} ref={register({required: false})} disabled={header.status==="r" ? true : false} />
								...
								<div className="form-group row">
										...
										<div className="form-group row col-md-10">
												<div className="checkbox checkbox-css">
													<input type="checkbox" id="multiwinner" name="multiwinner" defaultChecked={header.multiwinner === "y" || header.multiwinner === "1"} ref={register({required: false})}  disabled={orderPlacement==="paket" ? true : false} />
										...
										<div className="row">
												<div className="form-group row col-md-4">
														<div className="col-sm-12">
															<div className="checkbox checkbox-css">
																<input type="checkbox" id="bid_bond" name="bid_bond" defaultChecked={header.bid_bond === "y" || header.bid_bond === "1"} ref={register({required: false})} onChange={handleBidBond()} />
												...
												<div className="form-group row col-md-8">
														<div className="col-sm-12">
																<input type="number" step=".01" min="0.1" className="form-control" ref={register({ required: false })} name="bid_bond_value" placeholder="%" defaultValue={watchBidBond ? 0 : header.bid_bond_value} disabled={!watchBidBond} />
																<span className="text-right"> (Minimal 1%) {watchBidBond && <span className="text-danger">*</span>}</span>
														</div>
												</div>
										</div>
								</div>
