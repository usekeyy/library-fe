						...
						return (
								<tr key={i}>
										...
										<td>
											{
												<div>
													<button className="btn btn-xs btn-warning" onClick={(e) => handleEdit(e,i)} ><i className="danger fa fa-edit"></i></button>
													<button className="btn btn-xs btn-danger" onClick={(e) => handleDelete(e,i)} ><i className="danger fa fa-trash"></i></button>
												</div>
											}
										</td>
								</tr>
