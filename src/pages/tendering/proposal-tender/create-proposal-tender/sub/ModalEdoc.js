...
const ModalEdoc = (props) => {
	...
	// const modalType = props.parentState.modalTypeEdoc;
	// console.log(edocuments);
								...
								<Panel >
									...
									<div className="table-responsive">
										<table className="table table-bordered table-sm">
											...
											<tbody>
												{loadingBtn && load_rows}
												{loadingBtn === false && rows}
											</tbody>
										</table>
									</div>
								</Panel>
