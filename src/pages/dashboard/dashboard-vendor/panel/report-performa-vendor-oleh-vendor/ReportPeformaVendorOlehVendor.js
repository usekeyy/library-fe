...
class DashboardPerformaVendorOlehVendor extends Component {
    constructor(props) {
        super(props)
        ...
        return (
            <div>
                <Panel collapse={navigator.userAgent.indexOf("Firefox") > -1 ? false : true}>
                    <PanelHeader>
                        Report Performa Vendor Oleh Vendor
                    </PanelHeader>
                    <PanelBody>
                        <Row>
                            <Col>
...
export default connect(stateToProps, dispatchToProps)(withTranslation()(DashboardPerformaVendorOlehVendor));