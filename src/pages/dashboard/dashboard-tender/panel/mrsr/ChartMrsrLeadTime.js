...
import { getMrsrLeadTimeChart } from '../../../../../store/actions/dashboard/dashboardVendorAction';

class ChartMrsrLeadTime extends Component {
    constructor(props) {
        super(props)
        ...
        this.state = {
            ...
            options: {
                ...
                colors: ['#1aa3ff'],
                title: {
                    text: "MR/SR LEAD Time (MR/SR to PR)",
                    align: 'center',
                    margin: 10,
                    offsetX: 0,
                    offsetY: 0,
    ...
    getData = async () => {
      this.setState({ loading: true })
        this.props.getMrsrLeadTimeChart()
            .then((resp) => {
...
const dispatchToProps = dispatch => {
	return {
		getMrsrLeadTimeChart: (params) => dispatch(getMrsrLeadTimeChart(params)),
	}
}

export default connect(stateToProps, dispatchToProps)(withTranslation()(ChartMrsrLeadTime));
