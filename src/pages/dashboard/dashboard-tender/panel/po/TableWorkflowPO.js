...
import { getTenderPOWorkflowTable, downloadExcelPOWorkflow } from '../../../../../store/actions/dashboard/dashboardTenderAction';
// import FilterDate from '../../../../../components/filterdate/FilterDate';
// import { formatDate } from '../../../../../helpers/formatDate';
import { formatNumber } from '../../../../../helpers/formatNumber';

class TableWorkflowPO extends Component {
    constructor(props) {
        super(props)
    ...
    asyncData = async () => {
        ...
        this.props.getTenderPOWorkflowTable(this.state.params)
            .then((resp) => {
    ...
    getCheck = (check) => {
        ...
        filters.start = 0;
        if (check.length > 0) {
            filters.status_text = check.join(";");
    ...
    downloadExcel = () => {
        ...
        this.props.downloadExcelPOWorkflow()
			.then(res => {
                const url = window.URL.createObjectURL(new Blob([res.data]));
                const link = document.createElement('a');
                link.href = url;
                link.setAttribute('download', 'Report_Workflow_PO.xlsx'); //or any other extension
...
const dispatchToProps = dispatch => {
	return {
		...
		getTenderPOWorkflowTable: (params) => dispatch(getTenderPOWorkflowTable(params)),
        downloadExcelPOWorkflow : () => dispatch(downloadExcelPOWorkflow()),
	}
}

export default connect(stateToProps, dispatchToProps)( withTranslation() (TableWorkflowPO));
