...
import { getTenderSummaryPODetail } from '../../../../store/actions/dashboard/dashboardTenderAction';
...
class DetailSummaryOfPO extends Component {
    constructor(props) {
        super(props)
    ...
    asyncData = async () => {
        ...
        this.props.getTenderSummaryPODetail(this.state.params)
            .then((resp) => {                
                this.setState({
                    data: resp.data.data,
                                ...
                                <div>
                                    <table className="table table-sm text-nowrap">
                                      <tbody>
                                          ...
                                          <tr>
                                              <td>Source PO</td>
                                              <td>: {this.props.match.params.source.toUpperCase()}</td>
                                          </tr>
                                      </tbody>
                                   </table>
                                </div>
...
const dispatchToProps = dispatch => {
	return {
		getTenderSummaryPODetail: (params) => dispatch(getTenderSummaryPODetail(params)),
        downloadExcelPerformanceReport : () => dispatch(downloadExcelPerformanceReport()),
	}
}

export default connect(stateToProps, dispatchToProps)( withTranslation() (DetailSummaryOfPO));