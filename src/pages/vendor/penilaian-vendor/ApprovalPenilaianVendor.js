...
import FormApproval from './sub/FormApproval';

class ApprovalPenilaianVendor extends Component {
    constructor(props) {
        super(props)
        ...
        this.state = {
            ...
            notes : '',
            score: 0,
            isApprover : this.props.location.pathname.split("/")[2] === 'approval-penilaian-vendor' ? true : false,
        ...
        this.props.fetchVprApprovalDetailPenilaian(this.state.paramId)
            .then((resp) => {
                if(resp.data.data?.category){
                    let datax = resp.data.data.category.sort((a,b) => (a.category > b.category) ? 1 : ((b.category > a.category) ? -1 : 0))
    ...
    toList = (e) => {
        ...
        this.props.history.push('/vendor/approval-penilaian-vendor/'):
        this.props.history.push('/vendor/report-penilaian-vendor/') 
    }
        ...
        return (
            <div>
                <ol className="breadcrumb float-xl-right">
                    ...
                    <li className="breadcrumb-item active">Approval VPR Penilaian Vendor</li>
                </ol>
                <h1 className="page-header">Approval VPR Penilaian Vendor</h1>
                    <FormApproval 
                        ...
                        accessApproval = {this.props.access.A}
                    />
...
export default connect(stateToProps, dispatchToProps)(withTranslation()(ApprovalPenilaianVendor));
