...
class PenilaianVendorVerifikasi extends Component {
    constructor(props) {
        super(props)
        this._isMounted = false
        this.state = {
            dataTable : [],
            isApprove : this.props.location.pathname === '/vendor/approval-penilaian-vendor' ? true : false,
            params: {
                id: '',
                vendor_name: '',
                eproc_number: '',
        ...
        this.columns = [
            ...
            },
            {
                ...
                Cell: ({ value, original }) => (
                    // <React.Fragment>
                        <center>
                            {this.props.access.A && original.status === 'In Progress' && <button className="btn btn-xs btn-success" value={value} onClick={(e) => this.toDetailVerifikator(e, value)} >Process</button>}
                        </center>
                    // </React.Fragment>
                )
            },
...
export default connect(stateToProps, dispatchToProps)(withTranslation()(PenilaianVendorVerifikasi));