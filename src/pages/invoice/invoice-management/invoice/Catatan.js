        ...
        rows = Object.keys(props.data.note_list).map(function (key, index) {
            return (
                <tr key={key}>
                    ...
                    <td>{props.data.note_list[key]['created_at'] !== null && props.data.note_list[key]['created_at'] !== '' ? moment(props.data.note_list[key]['created_at']).format("DD-MM-YYYY") : ''}</td>
                </tr>
            )
        });
    }
                        ...
                        <div className="col-sm-12">
                            <div className="form-group">
                                ...
                                <div className="col-lg-12">
                                    <textarea disabled className="form-control" name="note"
