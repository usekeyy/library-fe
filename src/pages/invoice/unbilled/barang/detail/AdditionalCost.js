                                            ...
                                            <div className="table-responsive">
                                                <table className="table table-bordered table-striped table-sm text-wrap" align="left">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th>Amount</th>
                                                            <td style={{textAlign: "right"}}>{formatNumber2(props.data_header.amount, 2)}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            ...
                                            <table className="table table-bordered table-striped table-sm text-nowrap">
                                                ...
                                                <tbody>
                                                    <tr key={0}>
                                                        ...
                                                        <td style={{verticalAlign: 'middle'}}>{props.data['conditional_type']} - {props.data['condition_type_description']}</td>
                                                        <td style={{verticalAlign: 'middle', textAlign: "right"}}>{formatNumber2(props.data['qty'],3)}</td>
                                                        <td style={{verticalAlign: 'middle', textAlign: "right"}}>{formatNumber2(props.data['amount'],2)}</td>
                                                        {/* <td style={{verticalAlign: 'middle', textAlign: "right"}}>{formatNumber(props.data['amount_confirm'],2)}</td> */}
                                                        <td style={{verticalAlign: 'middle'}}>{props.data['currency']}</td>
                                                        <td style={{verticalAlign: 'middle'}}>{props.data['vendor_id']}</td>
                                                        <td style={{verticalAlign: 'middle'}}>{props.data['note']}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
