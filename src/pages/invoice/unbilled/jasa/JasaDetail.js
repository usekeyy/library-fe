...
export class JasaDetail extends Component {
    constructor(props) {
        super(props)
    ...
    toggleClose = () => {
        this.setState({ modalOpen:false, modalType:'', isError: false, errors: [] });
	}
        ...
        if (this._isMounted) {
            ...
            this.props
                ...
                .then((resp) => {
                    ...
                    datas.total_akhir = (parseFloat(datas.amount) - parseFloat(datas.penalty)).toFixed(2);
...
export default connect(stateToProps, dispatchToProps)(withTranslation()(JasaDetail));
