                ...
                <tr key={key}>
                    ...
                    <td>
                        {props.data[key]['file'] !== null &&
                            <span className="col-form-label" style={styleLink} onClick={(e) => props.toggleOpenPreview(e, props.data[key]['file'], `${process.env.REACT_APP_API_BASE_URL}files/invoice/${props.data[key]['file']}`)}>lampiran</span>
                        }
                    </td>
                    <td>
                                            ...
                                            <div className="table-responsive">
                                                <table className="table table-bordered table-striped table-sm text-wrap" align="left">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th>No. SA</th>
                                                            <td>{props.data_header.goods_receipt_number}</td>
                                                        </tr>
                                                        <tr>
                                                            <th>Service</th>
                                                            <td>{props.data_header.short_text}</td>
                                                        </tr>
                                                        <tr>
                                                            <th>Qty</th>
