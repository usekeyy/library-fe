                                    ...
                                    <div className="table-responsive">
                                        <table className="table table-bordered table-striped table-sm text-nowrap" align="left">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Delivery Note</th>
                                                    <td>{data.items[0].service_line[0].reference}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                        ...
                                        <table className="table table-bordered table-striped table-sm text-nowrap" align="left">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>{data.items[0].service_line[0].sap_created_by}</td>
                                                </tr>
                                                <tr>
                                                    <th>Created At</th>
                                    ...
                                    <tbody>{
                                        data.items !== undefined && 
                                            Object.keys(data.items).map(function (key, index) {
                                                let data_s = []
                                                data_s.push(data.items[key])
                                                if (data.items[key]['service_line'] !== undefined) {
                                                    data.items[key]['service_line'].forEach(element => {
                                                        data_s.push(element)
                                                    })
                                                }
                                                return (
                                                    data_s.map(function(data_service, index_service) {
                                                        return (
                                                            <tr key={index_service === 0 ? key : key + '-' +index_service}>
                                                                ...
                                                                {index_service === 0 &&
                                                                    <td rowSpan={data_s.length} style={{verticalAlign: "middle"}} align="center">{data_service['po_eproc_number']}</td>
                                                                }
                                                                {index_service === 0 &&
                                                                    <td rowSpan={data_s.length} style={{verticalAlign: "middle"}} align="center">{index_service === 0 && data_service['po_sap_number']}</td>
                                                                }
                                                                {index_service === 0 &&
                                                                    <td rowSpan={data_s.length} style={{verticalAlign: "middle"}} align="center">{index_service === 0 && data_service['po_item_no']}</td>
                                                                }
                                                                {index_service === 0 &&
                                                                    <td rowSpan={data_s.length} style={{verticalAlign: "middle"}} align="center">{index_service === 0 && data.items[key]['acc_assignment_category_id']}</td>
                                                                }
                                                                {index_service === 0 &&
                                                                    <td rowSpan={data_s.length} style={{verticalAlign: "middle"}} align="center">{index_service === 0 && data.items[key]['acc_assignment_category_number']}</td>
                                                                }
                                                                {index_service === 0 &&
                                                                    <td rowSpan={data_s.length} style={{verticalAlign: "middle"}} align="center">{index_service === 0 && data_service['gl_account']}</td>
                                                                }
                                                                <td>{data_service['short_text']}</td>
                                                                <td>{index_service !== 0 && data_service['line_no']}</td>
                                                                ...
                                                                <td>{index_service === 0 && formatNumber2(data_service['penalty'], 2)}</td>
                                                                <td>{index_service === 0 &&
