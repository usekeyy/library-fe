...
const PenaltyAddCost = (props) => {
    ...
    let [currency, setCurrency] = React.useState(null);
    ...
    const handleChange = (payload) => {
        ...
        setCurrency(props.data_header.currency)
    }
    const changeFile = (e) => {
        setLoading(!loading);
        if (e.target.files[0]){
	...
	const onAddPenalty = async data => {
        let status = false
        if (data.add_cost === undefined || data.add_cost === null || data.add_cost === '') {
            toastr.error('Mohon lengkapi data additional cost')
            status = true
        }
    ...
    if (props.data !== undefined) {
        rows = Object.keys(props.data).map(function (key, index) {
            return (
                <tr key={key}>
                    <td>{index+1}</td>
                    <td>{props.data[key]['conditional_type']} - {props.data[key]['conditional_type_description']}</td>
                    ...
                    <td>{props.data[key]['file'] !== null && props.data[key]['file'] !== '' && (
                        props.data[key]['id'] !== undefined ?
                            <p className="col-form-label" onClick={(e) => props.toggleOpenPreview(e, props.data[key]['file'], `${process.env.REACT_APP_API_BASE_URL}files/invoice/${props.data[key]['file']}`)} ><u>lampiran</u></p> : 
                            <p className="col-form-label" onClick={(e) => props.toggleOpenPreview(e, props.data[key]['file'], `${process.env.REACT_APP_API_BASE_URL}files/temp/${props.data[key]['file']}`)} ><u>lampiran</u></p>
                    )}
                    </td>
                    {!props.isReport &&
                        <td>
                            <button className="btn btn-xs btn-danger" value={key} onClick={(e) => props.toggleConfirm(e, key, 'penalty-add-cost')} ><i className="fa fa-trash"></i></button>
                        </td>
                    }
                </tr>
            )
                                ...
                                <div className="row">
                                    <div className="col-sm-12">
                                        <div className="form-group">
                                            <label>Additional Cost <span className="text-danger">*</span></label>
                                            ...
                                            <div>
                                                <Controller
                                                    ...
                                                    as={Select}
                                                    control={control}
                                                    options={props.data_option.m_add_cost}
                                                    onChange={([selected]) => {
                                                        handleChange(selected)
                                                        return selected;
                                                    }}
                                                    inputRef={(e) => register({ name: "add_cost", required: false })}
                                                    name="add_cost"
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input readOnly={true} className={(errors.currency || props.errors.currency) ? "form-control is-invalid" : "form-control"} name="currency" ref={register({ required: false })} defaultValue={currency || ''} />
                                        </div>
                                        <div className="form-group">
                                            ...
                                            <div className="form-group row">
                                                ...
                                                <div className="col-md-12">
                                                    ...
                                                    {props.param_penalty.file !== null &&
                                                        <p className="col-form-label" onClick={(e) => props.toggleOpenPreview(e, props.param_penalty.file, `${process.env.REACT_APP_API_BASE_URL}files/temp/${props.param_penalty.file}`)}><u>{props.param_penalty.file}</u></p>
                                                    }
                                                </div>
                                            </div>
                                            )}
