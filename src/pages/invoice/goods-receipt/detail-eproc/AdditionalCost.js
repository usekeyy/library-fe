        ...
        rows = Object.keys(props.data).map(function (key, index) {
            return (
                <tr key={key}>
                    ...
                    <td style={{verticalAlign: 'middle'}}>{props.data[key]['condition_type_id']} - {props.data[key]['condition_type_description']}</td>
                    <td style={{verticalAlign: 'middle', textAlign: "right"}}>{formatNumber2(props.data[key]['qty'],3)}</td>
                    <td style={{verticalAlign: 'middle', textAlign: "right"}}>{formatNumber2((parseFloat(props.data[key]['amount']) * parseFloat(props.data[key]['qty'])), 2)}</td>
