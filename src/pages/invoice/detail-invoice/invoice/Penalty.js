...
const Penalty = (props) => {
    ...
    //     props.setOptionPenalty(payload, code, key)
    // }
    ...
    return (
        <div>
            <Panel className="margin-bot-false">
                ...
                <PanelBody>
                    {(props.data.status === 'received' || props.data.status === 'approved_2') && props.user.has_roles.includes("INVER2") && props.data.items.length > 0 &&
                    <Row>
