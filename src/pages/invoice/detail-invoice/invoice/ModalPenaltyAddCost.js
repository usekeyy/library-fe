...
const ModalPenaltyAddCost = (props) => {
                            ...
                            <div className="row">
                                <div className="col-sm-12">
                                    ...
                                    <div className="form-group">
                                        <label>Add Cost <span className="text-danger">*</span></label>
                                        <div>
                                            <Controller
                                                ...
                                                defaultValue={props.param_modal.goods_receipt_add_cost_id || []}
                                                inputRef={(e) => register({ name: "goods_receipt_add_cost_id", required: true })}
                                                name="goods_receipt_add_cost_id"
                                                placeholder={ t("common:Select.Pilih") }
                                                // isLoading={loadings.penalty_type}
                                                rules={{ required: true }}
                                            />
                                            {errors.goods_receipt_add_cost_id && <span className="text-danger">{errors.goods_receipt_add_cost_id.type === "required" ? "Field harus diisi" : ''}  {errors.item_gr.message}</span>}
                                            {props.errors.goods_receipt_add_cost_id && <span className="text-danger">{props.errors.goods_receipt_add_cost_id[0]}</span>}
                                        </div>
                                    </div>
                                    <div className="form-group">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div>
                                            ...
                                            />
                                            {errors.debit_credit && <span className="text-danger">{errors.debit_credit.type === "required" ? "Field harus diisi" : ''}  {errors.item_gr.message}</span>}
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input disabled={true} className={(errors.currency || props.errors.currency) ? "form-control is-invalid" : "form-control"} name="currency" ref={register({ required: false })} defaultValue={props.data.add_cost.length > 0 ? props.data.add_cost[0].currency : props.data.currency} />
                                    </div>
                                    <div className="form-group">
...
export default withTranslation()(ModalPenaltyAddCost);
