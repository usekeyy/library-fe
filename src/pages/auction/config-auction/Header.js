                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-8">
                            <label className=" col-form-label">: {(props.data?.status !== undefined && props.data?.status !== null)? 
                                (props.data.status==="p") ? (new Date(localStorage.getItem('times')) < new Date(props.data.start_auction)) ? "Waiting" : (new Date(localStorage.getItem('times')) > new Date(props.data.start_auction) && Date.now() < new Date(props.data.end_auction)) ? "Live" : "Done" : 
